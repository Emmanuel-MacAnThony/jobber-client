import { FC, LazyExoticComponent, ReactElement, lazy, useState } from 'react';
          ...
          <div className="m-auto px-6 xl:container md:px-12 lg:px-6">
            <div className="flex flex-wrap items-center justify-between gap-6 md:gap-0 md:py-3 lg:py-5">
              <div className="flex w-full items-center justify-between lg:w-auto">
                <Link
                  to="/"
                  className="relative z-10 cursor-pointer text-3xl font-semibold hover:text-primary dark:hover:text-primaryLight"
                >
                  Jobber
                </Link>
